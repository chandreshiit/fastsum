...
# a = wordlist.fileids()
# #print('a=',a)
# b = wordlist.words(a[0])
# #print(b)
# c = wordlist.raw(a[0])
# #print(c)
# d = wordlist.sents(a)
# #print(d)
# #e = len(wordlist.sents(1))
# #print(e)
# f = len(wordlist.fileids())
# print(f)
# #词频
# k = "int id ddd ddd ddd dddeo"
# l = nltk.word_tokenize(k)
# v = l.count(l[0])
# print('v=',v)
# print(l)
# fdist1 = FreqDist(l)
...
# print(z)
# print(len(b)) #906
# print(fdist1) #<FreqDist with 373 samples and 906 outcomes>
# #g = fdist1[b[105]]
# #print(g)
# #print(b[105])
...
# print(m)
# #去掉标点符号
# oldS = "as30wejl2 @2]sj ls"
# rr = re.sub('[^a-zA-Z0-9 ]','',oldS)
# print(rr)


#输出每个文本的每个句子
#for i in range(len(a[0])):
#    print(wordlist.sents(a[0])[i])

#输出25个文章的所有句子
#for i in range(len(a)):
#    print(wordlist.sents(a[i]))
...
def Word_Frequency(text_sents,text_word,title,description,headline):
    ...
    # a= len(sents_word_frequency)
    # b = len(topic_title_frequency)
    # c = len(description_frequency)
    # d = len(headline_frequency)
    # e = len(sentence_length)
    # f = len(sentence_binary)
    # g = len(description_frequency)
    # h = len(sentence_value)
    # print(a )
    # print(b)
    # print(c)
    # print(d)
...
def Data_Model(i_num):
    ...
    useless, model_raw[0] = Preprocess_Raw(model_raw[0])
    for i in range(3):
        model_raw[i+1] = wordlist.raw(a[i_num*4 + i + 1])
        useless,model_raw[i+1] = Preprocess_Raw(model_raw[i+1])
...
def turn_to_sample(length,sents_word_frequency,topic_title_frequency,description_frequency,\
    ...
    print("zzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzz",length)
    all_sample = []
...
for j in range(len(data_predict)):
    save_file = "D:\\李卓聪\\save_file\\fastsum\\save_" + str(j) + ".txt"
    fl = open(save_file, 'w')
...
def read_weight_file(i):
    save_file = "D:\\李卓聪\\save_file\\fastsum\\save_" + str(i) + ".txt"
    f = open(save_file, 'r')
...
# summary,summary_word = get_summary(6)
# #print(summary)
# #print(summary_word)
#
# model_raw = Data_Model(7)
# ll = ['dd','ff','rr']
# kk = [['d','ff','rr'],['ddd','fdf','rr']]
# rouge_new_one = Rouge_new(model_raw, summary_word)
# print("resultttttttttttttttttttttt = ",rouge_new_one)